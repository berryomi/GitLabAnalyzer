...
class GitLabProject:
    ...
    def initialize_member_and_user_list(self) -> list:
    ...
    def get_commits_for_all_users(self) -> list:
        commitListsForAllUsers: list = self.initialize_member_and_user_list()
    ...
    @property
    def merge_request_manager(self):
        return self.__mergeRequestManager

    @property
    def commits_manager(self):
        return self.__commitsManager


# test version

gl = GitLab(token="EJf7qdRqxdKWu1ydozLe", url="https://cmpt373-1211-12.cmpt.sfu.ca/")
# gl = GitLab(token="c-Z7RjtQ1qtt2vWVYbjx", url="https://csil-git1.cs.surrey.sfu.ca/")
gl.authenticate()

print("\nSTART")
# interface = GitLabProject(25515)
interface = GitLabProject(2)
interface.update(gl)

dictionary = { "Administrator": ["jiwonj", "jaddiet", "xtran"] }
# dictionary = { "xtran": ["springbro294"], "fanghaof": ["HenryPC", "Henry Fang"] }
interface.call_map_users_to_members(dictionary)

for a in interface.merge_request_manager.merge_request_list:
    # print(a, "\n")
    print(a)
...
print("Changed commits list: ")
for commit in interface.commits_manager.get_commit_list():
    print(commit)


print ("\nXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
print("Get commits for all users")
for commit in interface.get_commits_for_all_users():
    print(commit)


print ("\nXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
print("Initialize member and user list")
for item in interface.initialize_member_and_user_list():
    print(item)
